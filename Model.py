...
conv_model.add(inp)
conv_model.add(Conv2D(128, kernel_size=4, activation='relu')) # TODO: the one here is usually for grayscale images, not sure how this will work with 1/0 bin
...
out_file_path = "C:/Users/Ethan/Documents/GitHub/monty/new_data_out_file.txt"
